...
W.SoundManager = function(smURL,smID) {
  ...
  this.initComplete = function() {
    ...
    _s._didInit = true;
    _s._wD('-- SoundManager2 '+(_s._disabled?'failed to load':'loaded')+' ('+(_s._disabled?'security/load error':'OK')+') --',1);
    if (_s._disabled) {
...
var soundManager = new W.SoundManager();
